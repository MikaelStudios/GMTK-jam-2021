...
public class PathMover : MonoBehaviour {
    ...
    void FixedUpdate () 
	{
        ...
        Vector3 position = Vector3.Lerp(m_Nodes[m_CurrentNode].m_Position.transform.localPosition, GetNextNode().m_Position.transform.localPosition, factor);
